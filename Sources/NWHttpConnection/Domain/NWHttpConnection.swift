...
struct NWHttpConnection: NWHttpConnectionType {
    ...
    init(url: URL, method: NWConnectionHTTPMethod, certificateValidation: CertificateValidationType, nwConnectionProvider: NWConnectionProviderType, timeout: TimeInterval = 30, queue: DispatchQueue? = nil) {
        self.url = url
        self.method = method
